...
public class IntentFlagsSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intent_flags_2);
        ...
        toNextActivityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (intent == null) {
                    intent = new Intent(IntentFlagsSecondActivity.this, IntentFlagsThirdActivity.class);
                }
                if (flag == -1) {
        ...
        switch (getIntent().getFlags()) {
            ...
            case Intent.FLAG_ACTIVITY_REORDER_TO_FRONT: {
                ...
                toNextActivityButton.setText(IntentFlagsActivity.class.getSimpleName());
                intent = new Intent(this, IntentFlagsActivity.class);
                break;
            }
            ...
            case Intent.FLAG_ACTIVITY_SINGLE_TOP: {
                ...
                toNextActivityButton.setText(IntentFlagsSecondActivity.class.getSimpleName());
                intent = new Intent(this, IntentFlagsSecondActivity.class);
                break;
            }
