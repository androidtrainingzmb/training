...
public class IntentFlagsActivity extends AppCompatActivity {
    private static final String TAG = IntentFlagsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flagOptionsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(IntentFlagsActivity.this, IntentFlagsSecondActivity.class);
