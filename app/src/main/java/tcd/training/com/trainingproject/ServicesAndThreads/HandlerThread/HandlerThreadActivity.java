package tcd.training.com.trainingproject.ServicesAndThreads.HandlerThread;
...
import tcd.training.com.trainingproject.ServicesAndThreads.ThreadPoolExecutor.DownloadImageTask;
...
//    private final String mImageUrl = "source.unsplash.com/4MSwGhLKhi8";
    ...
    public boolean handleMessage(Message message) {
        ...
        final Bitmap bitmap = (Bitmap) message.obj;
                ...
                if (mDisplayImages) {
                    ImageView imageView = new ImageView(HandlerThreadActivity.this);
