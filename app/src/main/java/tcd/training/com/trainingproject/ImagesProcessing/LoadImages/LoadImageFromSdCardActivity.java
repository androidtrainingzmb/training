...
public class LoadImageFromSdCardActivity extends AppCompatActivity {

    private static final String TAG = LoadImageFromSdCardActivity.class.getName();
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                snackbar.setAction("Grant", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ActivityCompat.requestPermissions(LoadImageFromSdCardActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
