...
public class ThreadPoolExecutorUsingCallableDemoActivity extends AppCompatActivity {
    ...
    private boolean displayImage(final Bitmap bitmap, final int threadId) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mDisplayImages) {
                    ImageView imageView = new ImageView(ThreadPoolExecutorUsingCallableDemoActivity.this);
